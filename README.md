...
| Pokémon Emerald (English, Generation 3) | [`encodings/pokegen3_en.tbl`](encodings/pokeEmerald_en.tbl) | Character encoding used by the English version of Pokémon Emerald  |
